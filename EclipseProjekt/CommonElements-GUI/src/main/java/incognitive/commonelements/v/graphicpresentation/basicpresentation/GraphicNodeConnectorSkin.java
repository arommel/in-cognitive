 ...
 */
public class GraphicNodeConnectorSkin extends GConnectorSkin {

    private static final String STYLE_CLASS = "graphic-node-connector";
    private static final String STYLE_CLASS_FORBIDDEN_GRAPHIC = "graphic-node-connector-forbidden-graphic";
    ...
    /**
     * Creates a new {@link GraphicNodeConnectorSkin} instance.
     *
     * @param connector the {@link GConnector} that this skin is representing
     */
    public GraphicNodeConnectorSkin(final GConnector connector) {
